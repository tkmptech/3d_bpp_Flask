...
class Packer:
    ...
    def pack(
        ...
        print("====> How many boxes are there for packing this time", len(Bins))
        # for bin in Bins:
    ...
    '''Give priority to the largest box. If the filling rate is greater than 80%, it is considered full by default and no more loading is done to prevent repeated selection from affecting system efficiency'''
